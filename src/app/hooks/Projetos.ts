...
const projetos = [
    ...
    },
    {
        titulo: 'Braz',
        categoria: 'CLI',
        texto: 'O Braz é uma aplicação que disponibiliza diversas funcionalidades com o intuito de auxiliar os desenvolvedores nos projetos que necessitam da geração de dados randômicos válidos dos principais documentos pessoais do Brasil, bem como sua validação.',
    ...
    },
    {
        titulo: 'Breve Link',
        categoria: 'API',
        texto: 'O Breve Link é uma prática API de encurtamento de URLs, tornando links longos mais curtos e fáceis de compartilhar. É uma solução simples e eficaz para simplificar o compartilhamento na web.',
        link: 'https://github.com/dev-macb/breve-link'
    }
];
