            ...
            <Secao>
                ...
                <div className='secao-direita-contato'>
                    <div className="redes-sociais">
                        <a className='butao-redes-sociais' target="_blank" href="https://github.com/dev-macb">Github</a>
                        <a className='butao-redes-sociais' target="_blank" href="https://www.linkedin.com/in/dev-macb/">LinkedIn</a>
                    </div>
                </div>
